...
# Stub class if albumentations not available
if not ALBUMENTATIONS_AVAILABLE:
    class ImageOnlyTransformStub:
        def __init__(self, always_apply=False, p=0.5):
            self.always_apply = always_apply
            self.p = p

class Erosion(A.ImageOnlyTransform if ALBUMENTATIONS_AVAILABLE else ImageOnlyTransformStub):
...
class Dilation(A.ImageOnlyTransform if ALBUMENTATIONS_AVAILABLE else ImageOnlyTransformStub):
    def __init__(self, scale, always_apply=False, p=0.5):
        super().__init__(always_apply=always_apply, p=p)
        if type(scale) is tuple or type(scale) is list:
            assert len(scale) == 2
...
class Bitmap(A.ImageOnlyTransform if ALBUMENTATIONS_AVAILABLE else ImageOnlyTransformStub):
...
class Fog(A.ImageOnlyTransform if ALBUMENTATIONS_AVAILABLE else ImageOnlyTransformStub):
...
class Frost(A.ImageOnlyTransform if ALBUMENTATIONS_AVAILABLE else ImageOnlyTransformStub):
    def __init__(self, mag=-1, always_apply=False, p=1.0):
        super().__init__(always_apply=always_apply, p=p)
        self.rng = np.random.default_rng()
        self.mag = mag
...
class Snow(A.ImageOnlyTransform if ALBUMENTATIONS_AVAILABLE else ImageOnlyTransformStub):
    def __init__(self, mag=-1, always_apply=False, p=1.0):
        super().__init__(always_apply=always_apply, p=p)
        self.rng = np.random.default_rng()
        self.mag = mag
...
class Rain(A.ImageOnlyTransform if ALBUMENTATIONS_AVAILABLE else ImageOnlyTransformStub):
    def __init__(self, mag=-1, always_apply=False, p=1.0):
        super().__init__(always_apply=always_apply, p=p)
        self.rng = np.random.default_rng()
        self.mag = mag
...
class Shadow(A.ImageOnlyTransform if ALBUMENTATIONS_AVAILABLE else ImageOnlyTransformStub):
    def __init__(self, mag=-1, always_apply=False, p=1.0):
        super().__init__(always_apply=always_apply, p=p)
        self.rng = np.random.default_rng()
        self.mag = mag
